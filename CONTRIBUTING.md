# Contributing to Open Modbus OM-16LED

Thank you for considering a contribution to the **Open Modbus OM-16LED** project!  
...
```bash
git clone https://github.com/<your-user>/OM-16LED.git
cd OM-16LED
```
...
Your contributions help make the OM-16LED better, safer, and more capable.
