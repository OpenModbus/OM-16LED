...
We take the security and reliability of the **Open Modbus OM-16LED** hardware, firmware, and software ecosystem seriously.  
...
[**https://github.com/OpenModbus/OM-16LED/security/advisories**](https://github.com/OpenModbus/OM-16LED/security/advisories)
...
- Third-party library bugs (unless they affect OM-16LED security)

### 🙏 Thank You

We appreciate the work of security researchers and users who help improve the safety of the project.  
Responsible disclosure ensures the **OM-16LED** remains reliable in industrial and automation environments.
